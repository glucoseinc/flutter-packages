...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.AVFoundationVideoPlayerApi.replaceDataSource', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.replaceDataSource was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final ReplaceDataSourceMessage? arg_msg = (args[0] as ReplaceDataSourceMessage?);
          assert(arg_msg != null,
              'Argument for dev.flutter.pigeon.AVFoundationVideoPlayerApi.replaceDataSource was null, expected non-null ReplaceDataSourceMessage.');
